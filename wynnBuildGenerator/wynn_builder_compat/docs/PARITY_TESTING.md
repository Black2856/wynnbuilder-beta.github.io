...
- `tools/export_js_fixtures/build_utils_fixture.mjs`
- `tests/test_js_build_utils_parity.py`
- `tools/export_js_fixtures/craft_effectiveness_fixture.mjs`
- `tests/test_js_craft_effectiveness_parity.py`
- `tools/export_js_fixtures/craft_preview_fixture.mjs`
- `tests/test_js_craft_preview_parity.py`
