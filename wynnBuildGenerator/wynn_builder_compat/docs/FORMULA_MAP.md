...
| `js/damage_calc.js` | `get_base_dps()` | `damage.py::get_base_dps()` | 部分実装 (parity test なし) |
| `js/damage_calc.js` | `calculateSpellDamage()` | `damage.py::calculate_spell_damage()` | 未実装 (NotImplementedError) |
